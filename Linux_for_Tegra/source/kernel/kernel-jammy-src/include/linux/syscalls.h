...
asmlinkage long sys_add_tp_syscall(int tid, int priority);
asmlinkage long sys_remove_tp_syscall(int tid);
asmlinkage long sys_trace_syscall(int option, char __user *num);
asmlinkage long sys_connect_pp_syscall(int priority, int port);
asmlinkage long sys_disconnect_pp_syscall(int port);
