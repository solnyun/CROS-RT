...
public:
    ...
    ChainNode(const std::string &name, double utilization, std::chrono::milliseconds period, const std::string &subscriber_topic, const std::string &publisher_topic)
    : Node(name), load(utilization_to_load(utilization, period)) {
...
int main(int argc, char *argv[]) {
    ...
    auto node = std::make_shared<ChainNode>(node_name, utilization, timer_period, subscriber_topic, publisher_topic);
